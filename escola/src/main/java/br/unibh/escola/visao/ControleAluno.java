...
import br.ajackson.escola_alysson.entidades.Aluno;
import br.ajackson.escola_alysson.negocio.ServicoAluno;
...
public class ControleAluno {
	...
	public void setAlunoes(List<Aluno> alunoes) {
		this.alunoes = alunoes;
	}
